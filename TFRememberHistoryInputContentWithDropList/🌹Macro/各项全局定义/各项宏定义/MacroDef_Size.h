...
static inline CGFloat StatusBarHeight(){
    if (@available(iOS 13.0, *)) {
        ...
        SuppressWdeprecatedDeclarationsWarning(return [[UIApplication sharedApplication] statusBarFrame].size.height);
    }
}
//导航栏高度
...
//    //即时获取
//    CGFloat tabBarHeight = AppDelegate.sharedInstance.tabBarVC.tabBar.frame.size.height;
...
//    return TabBarHeight() - 49 - JobsIMAppDelegate.sharedInstance.tabBarVC.myTabBar.offsetHeight;
//}
